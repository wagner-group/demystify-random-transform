...
class RandWrapperV8(RandWrapper):
    ...
    def apply_transforms(self, x, params, tf_order, fix_order_only=False, num_draws=None):
        ...
        t = TransformPicker(x.size(0), len(names), params.get('subset_size', len(names)),
                            tf_order=tf_order, n_samples=num_draws,
                            group_size=params.get('group_size'), seed=seed)
    ...
    def _forward(self, inputs, num_draws=None, params=None, rule=None,
        ...
        # Repeat inputs -> [x1, x2, x3, x1, x2, x3, ...]
        ...
        # print(torch.cuda.current_device(), torch.randint(0, 1000000, (1, )))
