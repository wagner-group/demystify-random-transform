...
class SignAdamax(Optimizer):
    ...
    def __init__(self, params, lr=2e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(SignAdamax, self).__init__(params, defaults)
...
def adamax(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        # delta = torch.sign(exp_avg / exp_inf)
        # param.add_(-clr * delta)
        param.add_(torch.sign(exp_avg) / exp_inf, alpha=-clr)
