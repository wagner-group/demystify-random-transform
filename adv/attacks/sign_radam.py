...
class SignRAdam(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(SignRAdam, self).__init__(params, defaults)
...
def radam(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        bias_corrected_exp_avg = torch.sign(exp_avg) / bias_correction1
        ...
        if rho_t > 5.:
            ...
            # param.add_(torch.sign(bias_corrected_exp_avg) * lr * adaptive_lr * rect, alpha=-1.0)
        else:
            param.add_(bias_corrected_exp_avg * lr, alpha=-1.0)
            # param.add_(torch.sign(bias_corrected_exp_avg) * lr, alpha=-1.0)
